...
export function AnimatedHero() {
  ...
  // Array of gemstone images that will rotate
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-transparent to-black/60 animate-pulse-slow" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl lg:text-7xl font-light text-white mb-8 tracking-tight text-balance drop-shadow-lg animate-slide-up">
            Ethically sourced
          ...
          <p className="text-xl lg:text-2xl text-white/90 mb-12 font-light leading-relaxed max-w-3xl mx-auto drop-shadow-md animate-slide-up-delay">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up-delay-2">
            <Button
              asChild
              size="lg"
              className="bg-white text-gray-900 hover:bg-gray-100 hover:scale-105 px-8 py-4 text-base font-medium rounded-full smooth-transition shadow-lg transform transition-transform"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-white/30 text-white hover:bg-white/10 hover:scale-105 px-8 py-4 text-base font-medium rounded-full smooth-transition backdrop-blur-sm bg-transparent transform transition-transform"
            >
